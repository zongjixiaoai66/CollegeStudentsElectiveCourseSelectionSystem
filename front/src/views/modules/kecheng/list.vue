                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/daxueshengxuanxiuxuanke/upload/kechengMuBan.xls"
                        >批量导入课程信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('kecheng','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('kecheng','选课')" type="primary" icon="el-icon-edit" size="mini" @click="xuanke(scope.row.id)">选课</el-button>
            ...
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        ...
                        sumColum : 'kecheng_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'kecheng_name',//分组字符串字段
